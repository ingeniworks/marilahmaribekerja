...
namespace GoWorkTwo
{
    public class CustomZXingScannerPage : ContentPage
    {
        ZXingScannerView zxing;
        ZXingDefaultOverlay defaultOverlay = null;

        public CustomZXingScannerPage(MobileBarcodeScanningOptions options = null, View customOverlay = null) : base()
        {
        ...
        protected override void OnAppearing()
        {
            ...
            zxing.Options = new MobileBarcodeScanningOptions()
            {
                ...
                {
                    foreach(var ares in availreso)
                    {
                        Debug.WriteLine($"Reso avail: {ares.Height}");
                    }
                    return availreso[0];
                }
            };
